...
const hot_news_left = [
  {
    title: "Dân tái định cư sân bay Long Thành mở quán xá rồi ngồi 'nhìn nhau'",
    image: "assets/images/news/news_search/new_1.png",
    category: "Đời sống",
    time: "5:34pm 16-03-23",
  },
  {
    title: "Dân tái định cư sân bay Long Thành mở quán xá rồi ngồi 'nhìn nhau'",
    image: "assets/images/news/news_search/new_2.png",
    category: "Đời sống",
    time: "5:34pm 16-03-23",
  },
  {
    title: "Dân tái định cư sân bay Long Thành mở quán xá rồi ngồi 'nhìn nhau'",
    image: "assets/images/news/news_search/new_3.png",
    category: "Đời sống",
    time: "5:34pm 16-03-23",
  },
  {
    title: "Dân tái định cư sân bay Long Thành mở quán xá rồi ngồi 'nhìn nhau'",
    image: "assets/images/news/news_search/new_4.png",
    category: "Đời sống",
    time: "5:34pm 16-03-23",
  },
  {
...
function updateLocalHotNews() {
  ...
  const content_right = hot_news_right.map((item, index) => {
    html +=
      '<div class="card card__news__left--extend"  style="display: block; margin-bottom: 5px;" href="./readnews.html">';
    html += '<img src="' + item.image + '" class="card-img-top" alt="...">';
    html += '<div class="card-body">';
    html +=
      '<span style="font-size: 16px; line-height: 16px; font-weight:700">' +
      item.title +
      "</span>";
    html += '<div class="category-time">';
    html +=
      '<p class="card-text" style="    margin: 0;"><small class="text-muted">' +
      item.category +
      "</small></p>";
    html +=
