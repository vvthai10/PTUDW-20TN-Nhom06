...
controller.showHomepage = async (req, res) => {
  ...
  let type = ['category-manage-1', 'category-manage-2', 'tag-manage', 'article-manage', 'user-manage-1', 'user-manage-2', 'user-manage-2'].includes(req.query.type) ? req.query.type : 'category-manage-1';
  ...
  {
    let options = {
      attributes: ['id', 'name', 'email',[sequelize.fn('COUNT', sequelize.col('Articles.id')), 'nArticle']],
      where: { role: 'writer'},
      include: [{
        model: models.Article,
        // as: ??? ,
